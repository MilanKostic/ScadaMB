...
public:
	const static unsigned int ventilVode = 1;
	const static unsigned int ventilPeska = 2;
	const static unsigned int ventilSljunka = 3;
	const static unsigned int mijesanje = 10004;
	const static unsigned int kamionDetektovan = 10005;

	const static unsigned int dozvolaPraznjenjaMjesalice = 1;
